			...
			<div class="content_table">
				<table>
					...
					<tr>
						...
						<td><input type="text" id = "lead_name" name = "lead_name" class="table_txt" /></td>

						<th>고객명<span class="acc_txt">*</span></th>
						<td><input type="text" id = "table_txt1" class="table_txt1" readonly="readonly" />
					...
					<tr>
						...
						<td><input type="text" id = "table_txt2" class="table_txt" readonly="readonly" />
						</td>
					</tr>
					<tr>
						...
						<td><input type="text" id = "table_txt3"class="table_txt1" readonly="readonly" />
