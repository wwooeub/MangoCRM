    	...
    	if ($.trim($("#pps_name").val()) == "") {
    		...
    		$.ajax({
    			...
    			success : function(result) {
    					...
    					makeAlert(1, "성공", "등록이 완료되었습니다.", function(){
			...
			<table class="table_normal">
                ...
                <tr>
                    ...
                    <td class="field_contents">
                        ...
                        readonly="readonly" id="mgr_name" name="mgr_name"/><div class="btn_black btn_size_normal" id="select">검색</div>
                    </td>
                </tr>
                <tr>
                <td class="field_name first_field_name">
                    ...
                    <td class="field_contents">
                    	<input type="text" class="input_normal input_readonly" readonly="readonly" id="depart_name" name="depart_name"/>
                    </td>
                <td class="field_name">
                 	   	담당자 이메일
                    </td>
                    <td class="field_contents">
                    	<input type="text" class="input_normal input_readonly" readonly="readonly" id="mgr_email" name="mgr_email"/>
                    </td>
                </tr>
			</table>
	</div>
