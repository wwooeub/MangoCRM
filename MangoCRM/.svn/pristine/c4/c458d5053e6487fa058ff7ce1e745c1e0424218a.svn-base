...
public interface ICmpDao {
	...
	List<HashMap<String, String>> selectCbox(HashMap<String, String> params) throws Throwable;

	List<HashMap<String, String>> selectCh(HashMap<String, String> params) throws Throwable;
