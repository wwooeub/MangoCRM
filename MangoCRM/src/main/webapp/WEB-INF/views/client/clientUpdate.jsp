...
$(document).ready(function() {
	...
	$("#btn_client_save").on("click",function() {
		...
		var linephoneRule = /^\d{2,4}-\d{3,4}-\d{4}$/;
		...
		if($.trim($("#txt_client_name").val()) == "") {
			...
			var html = "고객 정보를 수정하시겠습니까?";
			
			makeTwoBtnPopup(1, "고객 수정", html, true, 300, 200, null, "확인", function() {
				//jQuery 활용
				var params = $("#addForm").serialize(); //serialize폼안에 값 전달()
				$.ajax({
					type : "post", //데이터 전송방식
					url : "clientUpdateAjax", //주소
					...
					success : function(result) {
						if(result.res=="SUCCESS") {
							...
							makeAlert(1, "수정오류", "수정에 실패하였습니다", null);
						}
					},
...
function ClientGradeSet(grade) {
	...
	$("#dd_client_grade > option[value=${param.CC_GRADE_NO}]").attr("selected","true");
}
...
<body>
	...
	<div class="title_area">고객 수정</div>
		...
		<div class="contents_wrap">
			...
			<div class="table_top_area">
				...
				<div class="top_btn_area">
					<div class="btn btn_yellow btn_size_normal" id="btn_client_save">수정</div>
			...
			<!-- 테이블 영역입니다. -->
				<input type="hidden" id="client_no" name="client_no" value="${param.view_no}"  />
			<input type="hidden" id="view_no" name="view_no" value="${param.view_no}" />
				<table class="table_normal">
					...
					<tr>
						...
						<td class="field_contents">
							<input type="text" id="txt_client_name" name="txt_client_name" class="input_normal" value="${param.CLIENT_NAME}" />
						</td>
						<td class="field_name">
							고객사 <span class="acc_txt">*</span>
						</td>
					    <td class="field_contents">
							<input type="hidden" name="txt__client_company" id="txt__client_company" value="${param.COMP_NO}">
							<input type="text" id="txt__client_company_name" readonly="readonly" name="txt__client_company_name" class="input_size size75"  value="${param.COMP_NAME}" />
					...
					<tr>
						...
						<td class="field_contents">
							<input type="text" id="txt_client_depart" name="txt_client_depart" class="input_normal" value="${param.CLIENT_DEPART_NAME}"/>
						</td>
						<td class="field_name">
							직책
						</td>
						<td class="field_contents">
							<input type="text" id="txt_client_position" name="txt_client_position" class="input_normal" value="${param.CLIENT_POSI_NAME}"/>
						</td>
					</tr>
					<tr>
						...
						<td class="field_contents">
							<input type="text" id="txt_client_ph" name="txt_client_ph" maxlength="14" class="input_normal" value="${param.CLIENT_PH}" />
						</td>
						<td class="field_name">
							유선번호
						</td>
						<td class="field_contents">
							<input type="text" id="txt_client_ln" name="txt_client_ln" maxlength="14" class="input_normal" value="${param.CLIENT_LN}"/>
						</td>
					</tr>
					<tr>
						<td class="field_name first_field_name">
						...
						<td class="field_contents">
							<input type="text" id="txt_client_fax" name="txt_client_fax" maxlength="14" class="input_normal" value="${param.CLIENT_FAX}"/>
						</td>
						<td class="field_name">
							웹사이트
						</td>
						<td class="field_contents">
							<input type="text" id="txt_client_web" name="txt_client_web" class="input_normal" value="${param.CLIENT_WEBSITE}" />
						</td>
					</tr>
					<tr>
						...
						<td class="field_contents"> 
							<input type="text" id="txt_client_email" name="txt_client_email" class="input_normal" value="${param.CLIENT_EMAIL}" />
						</td>
						<td class="field_name">
						...
						<td class="field_contents">
							<select class="input_normal" id="dd_client_grade" name="dd_client_grade">
								<option selected="selected" value="${param.CC_GRADE_NO}">${param.CC_GRADE_NAME}</option>
					...
					<tr>
						...
						<td class="field_contents">
							<input class="cp_chbox" id="chk_client_cp" name="chk_client_cp" type="hidden" value="${param.CLIENT_CP}"/>
							<input class="cp_chbox" id="chk_client_ck" name="chk_client_ck" type="checkbox" value="${param.CLIENT_CP}"/>
						</td>
						<td class="field_name">
							담당자 <span class="acc_txt">*</span>
						</td>
						<td class="field_contents">
							<input type="hidden" name="txt_client_empno" id="txt_client_empno" value="${param.EMP_NO}">
							<input type="text" id="txt_client_empname" name="txt_client_empname" readonly="readonly" class="input_size size75" value="${param.EMP_NAME}"/>
